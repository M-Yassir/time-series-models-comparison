...
The LSTM model achieves an RMSE of $22.96 and MAPE of 2.62%, representing a **60.8% improvement in RMSE** and **59.9% improvement in MAPE** over
the ARIMA+GARCH approach. The MAE improvement of **60.4%** further confirms LSTM's superior performance.
```
